/* Ques # 24:
   ...
   . Test whether an item is not in a array.*/
          ...
          // test: === and !==//
   const string0: string = "Karachi";
   const string1: string = "Lahore";
...
const fruits: string[] = ["Karachi" , "Lahore" , "Islamabad" , "Faisalabad" ,"Mirpurkhas"];
console.log(fruits.includes("islamabad"));
console.log(fruits.includes("Islamabad"));
